...
def help(message):
    inform = '''
    В главном меню выберете необходимую функцию.
    ...
    -Верный ли перевод? введите 
    /guess
    -Викторина(англ-рус) введите 
    /guess_rus
    -Викторина(рус-англ) введите 
    /guess_eng
    -Напиши перевод введите 
    /wr_translate
    -Собери слово введите 
    /coword'''
...
словом/предложением. Бот выдаст перевод и картинку. '''
    bot.send_message(message.from_user.id, inform)
...
перевода на русский, необходимо выбрать верный вариант перевода слова. '''
    bot.send_message(message.from_user.id, inform)
